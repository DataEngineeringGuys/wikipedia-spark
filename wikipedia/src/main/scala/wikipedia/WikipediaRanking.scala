...
object WikipediaRanking {
   ...
   */
  def occurrencesOfLang(lang: String, rdd: RDD[WikipediaArticle]): Int = rdd.aggregate(0)((acc, value) => if (value.mentionsLanguage(lang)) acc + 1 else acc, (acc1, acc2) => acc1 + acc2)
